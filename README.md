...
- [1. Backdoor Attack & Defense](#1-Backdoor-Attack--Defense)
  - [1.1. Image Segmentation (图像分割)](#11-Image-Segmentation-(图像分割))
  - [1.2. Image Classification (图像分类)](#12-Image-Classification-(图像分类))
  - [1.3. Diffusion Model (扩散模型)](#13-Diffusion-Model-(扩散模型))
  - [1.4. Reinforcement Learning (强化学习)](#14-Reinforcement-Learning-(强化学习))
  - [1.5. Recommendation Systems (推荐系统)](#15-Recommendation-Systems-(推荐系统))
  - [1.6. Few-shot Learning (小样本学习)](#16-Few-shot-Learning-(小样本学习))
  - [1.7. Federated Learning (联邦学习)](#17-Federated-Learning-(联邦学习))
...
#### 1.5. Recommendation Systems (推荐系统)
...
#### 1.6. Few-shot Learning (小样本学习)

- **Does Few-Shot Learning Suffer from Backdoor Attacks?**
  - *AAAI, 2024.*

#### 1.7. Federated Learning (联邦学习)
